...
This example demonstrates how to use the NUCLEO-C031C6 board to blink an LED at different speeds when the user button is pressed.
The LED blink at three different speeds, and each press of the user button changes the blinking speed.
