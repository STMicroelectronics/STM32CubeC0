...
STM32 board LEDs are used to monitor the example status:
  ...
  - LED2 (BLEU) is ON when there is an error in initialization or if an incorrect CRC value is calculated.
...
### <b>Hardware and Software environment</b> 
  ...
  - This example has been tested with an STMicroelectronics NUCLEO-C092RC
