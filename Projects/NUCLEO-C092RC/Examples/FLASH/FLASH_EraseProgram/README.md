...
The NUCLEO-C092RC board LEDs can be used to monitor the transfer status:  
  ...
  - LED2 is blinking with a 2s period when there is an issue during erase or program procedure  
